...
public class SecurityTest implements TestData {
    ...
    public void ensureSecurityAnnotationPresentForEveryEndpoint() {
        List<ImmutablePair<Class<?>, Method>> notSecured =
            components.stream()
                ...
                .perform(
                    get(MESSAGE_BASE_URI)
                        .header(
                            ...
                            jwtTokenizer.getAuthToken(DEFAULT_USER, USER_ROLES, "-1L", 0, "admin", "admin")))
                .andDo(print())
                .andReturn();
            ...
            this.mockMvc
                .perform(
                    post(MESSAGE_BASE_URI)
                        ...
                        .header(
                            securityProperties.getAuthHeader(),
                            jwtTokenizer.getAuthToken(ADMIN_USER, ADMIN_ROLES, "", 0,"admin", "admin")))
                .andDo(print())
                .andReturn();
        MockHttpServletResponse response = mvcResult.getResponse();
            ...
            this.mockMvc
                .perform(
                    post(MESSAGE_BASE_URI)
                        ...
                        .header(
                            securityProperties.getAuthHeader(),
                            jwtTokenizer.getAuthToken(DEFAULT_USER, USER_ROLES, "", 0, "admin", "admin")))
                .andDo(print())
                .andReturn();
        MockHttpServletResponse response = mvcResult.getResponse();
